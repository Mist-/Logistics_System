	...
	private void initComponents() {
        ...
        //======== arrivalVO ========
        {
            ...
            //======== panel1 ========
            {
                ...
                saveArrival.setIcon(new ImageIcon(getClass().getResource("/icons/save_24x24.png")));
                        ...
                        .addGroup(panel1Layout.createSequentialGroup()
                            .addGroup(panel1Layout.createParallelGroup()
                                .addGroup(panel1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 484, Short.MAX_VALUE))
                                .addGroup(panel1Layout.createSequentialGroup()
                                    .addContainerGap()
                                    .addComponent(scrollPane1, GroupLayout.DEFAULT_SIZE, 683, Short.MAX_VALUE)
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)))
                            .addGroup(panel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                .addComponent(saveArrival, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
                                .addComponent(cancelArrival2, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
                                .addComponent(doArrive, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE))
                            .addContainerGap())
                        .addGroup(panel1Layout.createSequentialGroup()
                            .addContainerGap()
                            .addComponent(label1)
                    ...
                    panel1Layout.createParallelGroup()
                        .addGroup(GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                            ...
                            .addGroup(panel1Layout.createParallelGroup()
                                ...
                                .addComponent(modifyStatus, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE))
                            .addGap(4, 4, 4)
                            .addComponent(label2)
                            .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(panel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                .addGroup(GroupLayout.Alignment.LEADING, panel1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(doArrive, GroupLayout.PREFERRED_SIZE, 42, GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        //======== deliveryVO ========
        {
            ...
            //======== transferVO ========
            {
                ...
                createArrival.setIcon(new ImageIcon(getClass().getResource("/icons/ok_24x24.png")));
                    ...
                    transferVOLayout.createParallelGroup()
                        .addGroup(transferVOLayout.createSequentialGroup()
                            ...
                            .addGroup(transferVOLayout.createParallelGroup()
                                .addGroup(transferVOLayout.createSequentialGroup()
                                    .addComponent(scrollPane3, GroupLayout.DEFAULT_SIZE, 672, Short.MAX_VALUE)
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                    .addGroup(transferVOLayout.createParallelGroup()
                                        .addComponent(createArrival, GroupLayout.PREFERRED_SIZE, 108, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(transferCancel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                .addGroup(transferVOLayout.createSequentialGroup()
                                    .addGroup(transferVOLayout.createParallelGroup()
                                        .addComponent(label7)
                                    ...
                                    .addGroup(transferVOLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addComponent(fee, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE))
                    ...
                    transferVOLayout.createParallelGroup()
                        .addGroup(GroupLayout.Alignment.TRAILING, transferVOLayout.createSequentialGroup()
                            ...
                            .addGroup(transferVOLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(scrollPane3, GroupLayout.PREFERRED_SIZE, 252, GroupLayout.PREFERRED_SIZE))
                            .addContainerGap())
                );
            }
