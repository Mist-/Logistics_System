                    ...
                    panel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(panel1Layout.createSequentialGroup()
                            ...
                            .addGroup(panel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                .addComponent(status)
                                .addComponent(modifyStatus, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addGroup(DeliveryListPanelLayout.createSequentialGroup()
                            ...
                            .addGroup(DeliveryListPanelLayout.createParallelGroup()
                                .addGroup(DeliveryListPanelLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                    .addGroup(DeliveryListPanelLayout.createParallelGroup()
                                        .addComponent(cancelLoad, GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE)
                                        .addComponent(createArrival, GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE)))
                                .addGroup(DeliveryListPanelLayout.createSequentialGroup()
