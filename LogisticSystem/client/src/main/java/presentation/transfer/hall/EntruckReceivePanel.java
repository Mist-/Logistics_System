							...
							.addGroup(panel1Layout.createParallelGroup()
								.addGroup(panel1Layout.createSequentialGroup()
									...
									.addGroup(panel1Layout.createParallelGroup()
										...
										.addComponent(saveArrival, GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE)
										.addComponent(doArrive, GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE)
										.addComponent(cancelArrival, GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE)))
								.addGroup(panel1Layout.createSequentialGroup()
					...
					DeliveryListPanelLayout.createParallelGroup()
						.addGroup(DeliveryListPanelLayout.createSequentialGroup()
							...
							.addGroup(DeliveryListPanelLayout.createParallelGroup()
								...
								.addComponent(scrollPane3, GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)))
				);
			}
				...
				panel3Layout.setVerticalGroup(
					panel3Layout.createParallelGroup()
						.addGroup(GroupLayout.Alignment.TRAILING, panel3Layout.createSequentialGroup()
							...
							.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
							.addComponent(scrollPane4, GroupLayout.DEFAULT_SIZE, 304, Short.MAX_VALUE))
				);
			}
