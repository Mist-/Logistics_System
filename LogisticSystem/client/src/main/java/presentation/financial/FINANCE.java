                    ...
                    .addGroup(panel2Layout.createSequentialGroup()
                        ...
                        .addGroup(panel2Layout.createParallelGroup()
                            ...
                            .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(label4)))
                        .addGap(7, 7, 7)
                        .addComponent(panelMain, GroupLayout.DEFAULT_SIZE, 403, Short.MAX_VALUE))
            );
        }
                    ...
                    panel1Layout.setHorizontalGroup(
                        panel1Layout.createParallelGroup()
                            .addGroup(GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(scrollPane15, GroupLayout.DEFAULT_SIZE, 566, Short.MAX_VALUE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(panel1Layout.createParallelGroup()
                                    .addComponent(btAddP, GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE)
                                    .addComponent(btPExcel, GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE))
                                .addGap(8, 8, 8))
                    );
                        ...
                        panel1Layout.createParallelGroup()
                            .addGroup(panel1Layout.createSequentialGroup()
                                ...
                                .addGroup(panel1Layout.createParallelGroup()
                                    ...
                                    .addComponent(scrollPane15, GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE))
                                .addContainerGap())
                    );
                }
                    ...
                    panel3Layout.setHorizontalGroup(
                        panel3Layout.createParallelGroup()
                            .addGroup(panel3Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(scrollPane16, GroupLayout.DEFAULT_SIZE, 513, Short.MAX_VALUE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    //======== panel4 ========
                    {
                        ...
                        panel4Layout.setHorizontalGroup(
                            panel4Layout.createParallelGroup()
                                ...
                                .addGroup(panel4Layout.createSequentialGroup()
                                    .addComponent(scrollPane17, GroupLayout.DEFAULT_SIZE, 835, Short.MAX_VALUE)
                                    .addContainerGap())
                        );
            ...
            pnTJBBLayout.setHorizontalGroup(
                pnTJBBLayout.createParallelGroup()
                    .addGroup(pnTJBBLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(tpCost, GroupLayout.DEFAULT_SIZE, 833, Short.MAX_VALUE)
                        .addContainerGap())
            );
                ...
                pnZHGLLayout.createParallelGroup()
                    .addGroup(pnZHGLLayout.createSequentialGroup()
                        .addGroup(pnZHGLLayout.createParallelGroup()
                            ...
                            .addGroup(pnZHGLLayout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(tabbedPane3, GroupLayout.DEFAULT_SIZE, 551, Short.MAX_VALUE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)))
                        .addGroup(pnZHGLLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btAdd, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(btDelete, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE))
                        .addContainerGap())
            );
            ...
            panel5Layout.setHorizontalGroup(
                panel5Layout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING, panel5Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(scrollPane20, GroupLayout.DEFAULT_SIZE, 551, Short.MAX_VALUE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panel5Layout.createParallelGroup()
                            .addComponent(btAddP2, GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE)
                            .addComponent(btPExcel2, GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE))
                        .addContainerGap())
            );
                ...
                panel8Layout.setHorizontalGroup(
                    panel8Layout.createParallelGroup()
                        .addGroup(panel8Layout.createSequentialGroup()
                            .addContainerGap()
                            .addComponent(scrollPane22, GroupLayout.DEFAULT_SIZE, 506, Short.MAX_VALUE)
                            .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
