    ...
    private void initComponents() {
					...
					panel1Layout.setHorizontalGroup(
						panel1Layout.createParallelGroup()
							.addGroup(GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
								.addContainerGap()
								.addComponent(scrollPane15, GroupLayout.DEFAULT_SIZE, 562, Short.MAX_VALUE)
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(panel1Layout.createParallelGroup()
									.addComponent(btAddP, GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
									.addComponent(btPExcel, GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE))
								.addGap(8, 8, 8))
					);
		...
		//======== pnQCJZ ========
		{
			...
			//======== panel6 ========
			{
				...
				//---- chkNot ----
				chkNot.setText("\u5168\u4e0d\u9009");
				chkNot.setFont(new Font("\u7b49\u7ebf", Font.PLAIN, 14));
