                    ...
                    panel1Layout.setHorizontalGroup(
                        panel1Layout.createParallelGroup()
                            .addGroup(GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(scrollPane15, GroupLayout.DEFAULT_SIZE, 565, Short.MAX_VALUE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(panel1Layout.createParallelGroup()
                                    .addComponent(btAddP, GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)
                                    .addComponent(btPExcel, GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE))
                                .addGap(8, 8, 8))
                    );
                ...
                pnZHGLLayout.createParallelGroup()
                    .addGroup(pnZHGLLayout.createSequentialGroup()
                        ...
                        .addGroup(pnZHGLLayout.createParallelGroup()
                            ...
                            .addComponent(tabbedPane3, GroupLayout.DEFAULT_SIZE, 364, Short.MAX_VALUE))
                        .addContainerGap())
            );
        }
                ...
                panel7Layout.setHorizontalGroup(
                    panel7Layout.createParallelGroup()
                        .addGroup(GroupLayout.Alignment.TRAILING, panel7Layout.createSequentialGroup()
                            .addContainerGap()
                            .addComponent(scrollPane21, GroupLayout.DEFAULT_SIZE, 567, Short.MAX_VALUE)
                            .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
