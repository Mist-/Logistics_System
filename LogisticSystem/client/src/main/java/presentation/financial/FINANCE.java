    ...
    private void initComponents() {
        ...
        //======== pnZJGL ========
        {
                    ...
                    panel7Layout.setHorizontalGroup(
                        panel7Layout.createParallelGroup()
                            .addGroup(GroupLayout.Alignment.TRAILING, panel7Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(scrollPane21, GroupLayout.DEFAULT_SIZE, 558, Short.MAX_VALUE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    panel8Layout.setHorizontalGroup(
                        panel8Layout.createParallelGroup()
                            .addGroup(panel8Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(scrollPane22, GroupLayout.DEFAULT_SIZE, 501, Short.MAX_VALUE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
            ...
            pnZJGLLayout.setHorizontalGroup(
                pnZJGLLayout.createParallelGroup()
                    .addGroup(pnZJGLLayout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(pnZJGLLayout.createParallelGroup()
                            .addComponent(tabbedPane4, GroupLayout.Alignment.TRAILING)
                            .addGroup(pnZJGLLayout.createSequentialGroup()
                                .addComponent(tabbedPane6, GroupLayout.PREFERRED_SIZE, 678, GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addContainerGap())
            );
            pnZJGLLayout.setVerticalGroup(
                pnZJGLLayout.createParallelGroup()
                    .addGroup(pnZJGLLayout.createSequentialGroup()
                        .addComponent(tabbedPane6, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        ...
        //======== pnQCJZ ========
        {
            ...
            //======== panel6 ========
            {
                ...
                labelVehicle.setFont(new Font("\u7b49\u7ebf", Font.PLAIN, 14));

                //---- labelDriverInfo ----
                labelDriverInfo.setText("\u5c1a\u672a\u8fdb\u884c\u8fc7\u671f\u521d\u5efa\u8d26");
                labelDriverInfo.setFont(new Font("\u7b49\u7ebf", Font.PLAIN, 14));

                //---- labelPayment ----
                labelPayment.setText("\u5c1a\u672a\u8fdb\u884c\u8fc7\u671f\u521d\u5efa\u8d26");
                labelPayment.setFont(new Font("\u7b49\u7ebf", Font.PLAIN, 14));

                //---- labelReceipt ----
                labelReceipt.setText("\u5c1a\u672a\u8fdb\u884c\u8fc7\u671f\u521d\u5efa\u8d26");
                labelReceipt.setFont(new Font("\u7b49\u7ebf", Font.PLAIN, 14));

                //---- labelAccount ----
                labelAccount.setText("\u5c1a\u672a\u8fdb\u884c\u8fc7\u671f\u521d\u5efa\u8d26");
                labelAccount.setFont(new Font("\u7b49\u7ebf", Font.PLAIN, 14));

                //---- labelStaff ----
                labelStaff.setText("\u5c1a\u672a\u8fdb\u884c\u8fc7\u671f\u521d\u5efa\u8d26");
                labelStaff.setFont(new Font("\u7b49\u7ebf", Font.PLAIN, 14));
                ...
                //---- labelStaff2 ----
                labelStaff2.setText("\u5c1a\u672a\u8fdb\u884c\u8fc7\u671f\u521d\u5efa\u8d26");
                labelStaff2.setFont(new Font("\u7b49\u7ebf", Font.PLAIN, 14));
            ...
            panel5Layout.setHorizontalGroup(
                panel5Layout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING, panel5Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(scrollPane20, GroupLayout.DEFAULT_SIZE, 552, Short.MAX_VALUE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
